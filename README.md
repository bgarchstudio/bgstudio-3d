...
## v1.2
- Google Analytics 4 eklendi (`G-WHJ7Y7KN3L`).
- WhatsApp potansiyel müşteri ve paylaşım etkileşimleri GA4 olaylarıyla ölçülür.
- Gizlilik sayfası Analytics kullanımı için güncellendi.


## v1.2 küçük kalite turu
- Ürün galeri küçük görsellerine açıklayıcı alt metinler eklendi.
- Gizlilik ve Sipariş Bilgilendirme meta açıklamaları geliştirildi.
- GA4 ölçümü korunuyor.
