...
def build_site():
    ...
    static = [
        ...
        ('/kurumsal/', .9), ('/kusadasi-3d-baski/', .95), ('/nfc-qr/', .9), ('/prototip-parca/', .9), ('/ozel-uretim/', .9),
