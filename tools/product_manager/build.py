...
def render_nfc_platform_sections(theme_overrides=None):
    ...
    return f'''<!-- NFC_PLATFORM_V160_START -->
<!-- NFC_REFERENCE_SLOT -->
...
def rebuild_nfc_platform_sections(html_text, theme_overrides=None):
    ...
    marker_pattern = re.compile(
        r'<!--\s*NFC_PLATFORM_V(?:145|153|154|155|156|159|160)_START\s*-->.*?<!--\s*NFC_PLATFORM_V(?:145|153|154|155|156|159|160)_END\s*-->',
        flags=re.I | re.S,
    )
...
def rebuild_nfc_reference_section(html_text, cards_html):
    ...
    V3.1.60 keeps proof-of-work as the first content block of the NFC page. The platform renderer
